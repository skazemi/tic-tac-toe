...
from PyQt5.QtWidgets import QWidget, QApplication, QPushButton, QLabel, QMenuBar, QStatusBar
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(QApplication.translate("MainWindow", "Tic-Tac-Toe", None))
        self.centralwidget = QWidget(MainWindow)
        self.centralwidget.setObjectName(_fromUtf8("centralwidget"))
        self.pushButton = QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(680, 10, 88, 27))
        self.pushButton.setText(QApplication.translate("MainWindow", "New Game", None))
